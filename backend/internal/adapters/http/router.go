...
func NewRouter(cfg config.Config, services Services) *gin.Engine {
	...
	pages.POST("/dashboard/cloudflare/reload-zones", services.Pages.CloudflareReloadZonesSubmit)
	...
	authed.POST("/cloudflare/zones/reload", services.Cloudflare.ReloadZones)
